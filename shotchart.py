...
# get_player_shotchartdetail: player_id, season_id -> player_shotchart_df, league_avg
...
def shot_chart(data, title="", color="b", xlim=(-250, 250), ylim=(422.5, -47.5), line_color="blue",
    ...
    # Plot missed shots
    ax.scatter(x_missed, y_missed, c='r', marker="x", s=150, linewidths=3)
    # Plot made shots
    ax.scatter(x_made, y_made, facecolors='none', edgecolors='g', marker='o', s=150, linewidths=3)
...
def plot(player_name,season_id):
    # title
